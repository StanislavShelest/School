...
public class Main {
    public static void main(String args[]) {
        ...
        System.out.println("Матрица номер 1:" + System.lineSeparator() + matrix1.toString());

        Matrix matrix2 = new Matrix(matrix1);
        System.out.println("Матрица номер 2:" + System.lineSeparator() + matrix2.toString());

        double[][] arrayTwoDimensional1 = {{2, 3, 4}, {3, 7, 9}, {5, 6, 7}, {12, 11, 13}};
        Matrix matrix3 = new Matrix(arrayTwoDimensional1);
        System.out.println("Матрица номер 3:" + System.lineSeparator() + matrix3.toString());
        ...
        System.out.println("Матрица номер 4:" + System.lineSeparator() + matrix4.toString());
        ...
        System.out.println("Матрица номер 5:" + System.lineSeparator() + matrix5.toString());
        ...
        System.out.println("Первая матрица имеет размеры: " + Arrays.toString(matrix1.getSize()));

        matrix1.setComponent(numberLineEnter, numberColumnEnter, elementEnter);
        System.out.println("Матрица номер 1 после измения значения: " + System.lineSeparator() + matrix1.toString());

        System.out.println("В матрице номер 1 в строке номер " + numberLineEnter + " элементом под номером " +
                numberColumnEnter + " является: " + matrix1.getComponent(numberLineEnter, numberColumnEnter));

        System.out.println("Вектор-столбец матрицы номер 3: " + Arrays.toString(matrix3.getVectorColumn(numberColumn)));

        System.out.println("Матрица номер 3 после транспонирования: " + System.lineSeparator() + matrix3.getTranspose().toString());

        System.out.println("Матрица номер 4 после умножения на скаляр: " + System.lineSeparator() + matrix4.getMultiplicationByScalar(scalar).toString());
        ...
        System.out.println("Результат вычитания статическим методом матриц 11 и 12: " + Matrix.getSubtraction(matrix11, matrix12).toString());
